...
`R` for Data Science, 2nd Edition (Wickham, Çetinkaya-Rundel, and Grolemund, 2023)  

* Functions: https://r4ds.hadley.nz/functions.html 
* Iteration: https://r4ds.hadley.nz/iteration.html  


Advanced `R`, 2nd Edition (Wickham, 2019)    
