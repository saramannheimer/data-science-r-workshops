...
```{r challenge-2-solution, eval=T, echo=F}
...
```{r challenge-2-2-solution, eval=T, echo=T}
...
```{r challenge-3-solution, eval=T, echo=T}
2 * x + 0.2 == y
...
```{r challenge-5-solution, eval=T, echo=T}
messages > 12
...
```{r challenge-6-solution, eval=T, echo=T}
...
```{r challenge-7-solution, eval=T, echo=T}
...
```{r challenge-8-solution, eval=T, echo=T}
...
```{r challenge-9-solution, eval=T, echo=T}
last <- tail(messages$okcupid, 1)
...
```{r challenge-10-solution, eval=T, echo=T}
last <- tail(messages$okcupid, 1)
...
```{r challenge-11-solution, eval=T, echo=T}
z <- x + y
z
...
```{r challenge-12-solution, eval=T, echo=T}
BlackfootFish <- read.csv("https://raw.githubusercontent.com/saramannheimer/data-science-r-workshops/master/Intermediate%20R/AY%202020-2021/data/BlackfootFish2.csv", header = TRUE)
...
```{r challenge-13-solution, eval=T, echo=T}
feet_inch_to_cm(5,7)
...
```{r challenge-14-solution, eval=T, echo=T}
x <- BlackfootFish$length
...
```{r challenge-15-solution, eval=T, echo=T}
x <- BlackfootFish$length
...
```{r challenge-16-solution, eval=T, echo=T}
rescale <- function(x){
  x_range <- range(x, na.rm = TRUE)
...
```{r challenge-17-solution, eval=T, echo=T}
x <- c(1, 2, 3, 4, 5)
...
```{r challenge-18-solution, eval=T, echo=T}
...
```{r challenge-19-solution, eval=T, echo=T}
...
```{r challenge-19-2-solution, eval=T, echo=T}
