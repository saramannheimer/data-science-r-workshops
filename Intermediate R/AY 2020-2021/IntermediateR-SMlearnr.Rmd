...
```{r whyError, message=TRUE, exercise=TRUE, eval = FALSE}
...
```{r extractDataframe, exercise=TRUE, exercise.eval=TRUE}
...
```{r moreExtract, exercise=TRUE, exercise.eval=TRUE}
...
```{r challenge-2, exercise=TRUE, exercise.lines = 7}
...
```{r challenge-2-2, exercise=TRUE, exercise.lines = 7}
