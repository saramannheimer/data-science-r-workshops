...
```{r equality, tidy = TRUE, exercise=TRUE, exercise.setup="relOp-setup"}
dna1 == dna2
dna1 != dna2
```
...
```{r greaterLess, tidy = TRUE, exercise=TRUE, exercise.setup="relOp-setup"}
w > 10
x > y
```
...
```{r inclusion, tidy = TRUE, exercise=TRUE}
...
```{r challenge-3, tidy = TRUE, exercise=TRUE, exercise.lines = 10, exercise.setup="relOp-setup"}
...
![](images/recycling.png "Graphic demonstrating left and right character vectors with empty slots for the shorter right vector.")


When one vector is shorter than the other, it gets *recycled*:


![](images/recycling2.png "Graphic demonstrating left and right character vectors and how the right vector is recycled.")
...
```{r which, tidy = TRUE, exercise=TRUE, exercise.lines=10}
...
```{r matricies, tidy = TRUE, exercise=TRUE, exercise.lines=11}
...
```{r challenge-5, tidy = TRUE, exercise=TRUE, exercise.lines = 7}
...
```{r challenge-6, tidy = TRUE, exercise=TRUE, exercise.lines=10,exercise.setup="challenge-5-setup"}
...
```{r subset, tidy = TRUE, exercise=TRUE}
...
```{r doubleLogical, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r logicals, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r subset2, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r if, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}  
y <- -3 
...
```{r challenge-8, tidy = TRUE, exercise=TRUE, exercise.lines = 7}
...
```{r ifelse, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}  
y <- -3 
...
```{r ifelse2, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r challenge-9, tidy = TRUE, exercise=TRUE, exercise.lines = 7}
...
```{r elseif, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}  
y <- -3 
...
```{r mutually, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
statement. Directly after the repeat statement, in curly braces, are the instructions that are to be repeated. You will find the formatting that you like
...
```{r forloop, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r twoVectors, eval = FALSE, exercise=TRUE, exercise.eval=TRUE}
...
```{r challenge-10, tidy = TRUE, exercise=TRUE, exercise.lines=7}
...
__Remark:__ Like we used in the above `for` loop, it is often useful, to add a 
...
```{r challenge-11, tidy = TRUE, eval = FALSE, exercise=TRUE, exercise.lines = 7}
...
```{r nestingForLoops, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
for(i in 1:5){
...
```{r Functions, exercise=TRUE, exercise.eval=TRUE}
...
__Exercise 12__: Use the `inch_to_cm` function to convert your height to cm!  


```{r challenge-12, tidy = TRUE, eval = FALSE, exercise=TRUE, exercise.lines = 7}
...
```{r scope, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
x <- 10
...
```{r scope2, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r WhyFunction, eval = FALSE, exercise=TRUE, exercise.eval=TRUE}
...
```{r rescalingFunction, eval = FALSE, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r temporary, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r rangeFunction, exercise=TRUE, exercise.eval=TRUE}
range(seq(1, 5))     
```
...
```{r challenge-14, eval = FALSE, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r function, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r challenge-16, tidy = TRUE, exercise=TRUE, exercise.lines=7}
...
```{r challenge-17, tidy = TRUE, exercise=TRUE, exercise.lines=7}
...
```{r challenge-18, tidy = TRUE, exercise=TRUE, exercise.lines=7}
...
```{r challenge-18-2, tidy = TRUE, exercise=TRUE, exercise.lines=7}
