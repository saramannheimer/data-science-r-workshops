...
```{r relOp, exercise=TRUE, exercise.eval=TRUE}
w <- 10.2 
x <- 1.3
y <- 2.8 
z <- 17.5
...
```{r equality, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
dna1 == dna2
dna1 != dna2
```
...
```{r greaterLess, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
w > 10
x > y
```
...
```{r inclusion, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r challenge-3, tidy = TRUE, exercise=TRUE, exercise.lines = 7}
...
```{r compareCharacters, eval = FALSE}
Sys.getlocale()
...
```{r inclusionOp, exercise=TRUE, exercise.eval=TRUE}
...
```{r extractLetters, exercise=TRUE, exercise.eval=TRUE}
...
```{r which, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r matricies, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r challenge-6, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
...
```{r subset, tidy = TRUE, exercise=TRUE, exercise.eval=TRUE}
