...
```{r doubleLogical, tidy = TRUE, exercise=TRUE}
...
```{r logicals, tidy = TRUE, exercise=TRUE}
...
```{r subset2, tidy = TRUE, exercise=TRUE, exercise.setup="challenge-5-setup"}
...
```{r ifelse, tidy = TRUE, exercise=TRUE}  
y <- -3 
...
```{r ifelse2, tidy = TRUE, exercise=TRUE}
...
```{r elseif, tidy = TRUE, exercise=TRUE}  
y <- -3 
...
```{r mutually, tidy = TRUE, exercise=TRUE}
...
```{r forloop, tidy = TRUE, exercise=TRUE}
...
```{r nestingForLoops, tidy = TRUE, exercise=TRUE}
for(i in 1:5){
...
```{r scope, tidy = TRUE, exercise=TRUE}
x <- 10
...
```{r scope2, tidy = TRUE, exercise=TRUE}
...
```{r WhyFunction, eval = FALSE, exercise=TRUE}
...
```{r rescalingFunction, eval = FALSE, tidy = TRUE, exercise=TRUE}
...
```{r temporary, tidy = TRUE, exercise=TRUE}
...
```{r challenge-14, eval = FALSE, tidy = TRUE, exercise=TRUE}
...
```{r function, tidy = TRUE, exercise=TRUE}
