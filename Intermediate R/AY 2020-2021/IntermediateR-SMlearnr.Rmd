...
with the $1^{st}$ row, until you've sampled 1900 rows. This would allow us to split the data set into "testing" and "training" samples, possibly using the `testing` data for assessing a model we develop using the "training" data.
...
```{r challenge-19-2, exercise=TRUE, exercise.lines=7}
...
BlackfootFish$condind <- condition_index(BlackfootFish$weight, BlackfootFish$length)

summary(BlackfootFish$condind)

D1 <- subset(BlackfootFish, !is.na(condind) & condind <= 2)
