...
```{r challenge-2-solution, eval=F, echo=F}
...
```{r challenge-2-2-solution, eval=F, echo=F}
...
```{r challenge-3-solution, eval=F, echo=F}
2 * x + 0.2 == y
...
```{r challenge-5-solution, eval=F, echo=F}
messages > 12
...
```{r challenge-6-solution, eval=F, echo=F}
...
```{r challenge-7-solution, eval=F, echo=F}
...
```{r challenge-8-solution, eval=F, echo=F}
...
```{r challenge-9-solution, eval=F, echo=F}
last <- tail(messages$okcupid, 1)
...
```{r challenge-10-solution, eval=F, echo=F}
last <- tail(messages$okcupid, 1)
...
```{r challenge-11-solution, eval=F, echo=F}
z <- x + y
z
...
```{r challenge-12-solution, eval=F, echo=F}
BlackfootFish <- read.csv("https://raw.githubusercontent.com/saramannheimer/data-science-r-workshops/master/Intermediate%20R/AY%202020-2021/data/BlackfootFish2.csv", header = TRUE)
...
```{r challenge-13-solution, eval=F, echo=F}
feet_inch_to_cm(5,7)
...
```{r challenge-14-solution, eval=F, echo=F}
x <- BlackfootFish$length
...
```{r challenge-15-solution, eval=F, echo=F}
x <- BlackfootFish$length
...
```{r challenge-16-solution, eval=F, echo=F}
rescale <- function(x){
  x_range <- range(x, na.rm = TRUE)
...
```{r challenge-17-solution, eval=F, echo=F}
x <- c(1, 2, 3, 4, 5)
...
```{r challenge-18-solution, eval=F, echo=F}
...
```{r challenge-19-solution, eval=F, echo=F}
...
```{r challenge-19-2-solution, eval=F, echo=F}
