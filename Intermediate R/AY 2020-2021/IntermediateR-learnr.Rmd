...
\frac{100000 \ast weight}{length^3}$), making any fish with weight or heights of 0s to be NAs on the condition factor since those are obvious data entry errors.  
