...
header-includes: |
  \usepackage{fancyhdr}
  \pagestyle{fancy}
  \fancyfoot[LO,RE]{Session 1: Intro to R - Presenter}
...
However you get to it, RStudio has four possible panels, where each can be viewed 
at the same time and has multiple tabs available.  
...
## No - need to specify how to remove any pair with at least one NA
cor(BlackfootFish$length, BlackfootFish$weight,
...
The workshops for 2025 involve modifications of materials and are being 
taught by:
