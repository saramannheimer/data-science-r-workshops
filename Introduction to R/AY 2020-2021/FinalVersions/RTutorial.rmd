...
author: "Data & Software Carpentry, the Montana State University `R` Workshops Team"
output:
  pdf_document:
    fig_height: 3
    fig_width: 5
...
![Examples of lists](list_example.png)
...
mean(BlackfootFish$weight, argument here! )  ## review the help and add in the argument
## that removes the NA's

median(BlackfootFish$species) ## gives an error because input is not correct data type  
...
This instructional material is made available under the Creative Commons Attribution license (https://creativecommons.org/licenses/by/4.0/) (CC-BY 4.0).
