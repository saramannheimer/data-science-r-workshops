...
author: "Data & Software Carpentry, with reorganization from Allison Theobold"
output:
  pdf_document:
    fig_height: 3
    fig_width: 5
...
all the project's pieces are in the same folder. This allows for a clean 
...
only in comments. In an Rnw (Markdown) file (report.Rnw), commands are 
