...
quiz(caption = "Quiz - Install R",
  ...
  question("What is the current version of R?",
    answer("3.3.2", message = "It is at least version 4.2.0."),
    answer("3.6.2", message = "It is at least version 4.2.0."),
    answer("4.0.5", message = "It is at least version 4.2.0."),
    answer("4.2.0", correct = TRUE, "It was version 4.2.0 when I built this, but the current version might have a higher number (could be newer)."),
    answer("Other", message = "It was version 4.2.0 when I built this, but the current version might have a higher number (could be newer).")
  )
)
...
quiz(caption = "Quiz - Install RStudio",
  ...
  question("What is the current version of RStudio IDE?",
    ...
    answer("4.2.0", message = "That was the current version of R, RStudio is at least version 2022.02.3."),
