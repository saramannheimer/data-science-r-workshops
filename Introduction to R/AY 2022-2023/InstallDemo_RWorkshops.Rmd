...
quiz(caption = "Quiz - Install R",
  ...
  question("What is the current version of R?",
    answer("3.3.2", message = "It is at least version 4.1.1."),
    answer("3.6.2", message = "It is at least version 4.1.1."),
    answer("4.0.5", message = "It is at least version 4.1.1."),
    answer("4.1.1", correct = TRUE, "It was version 4.1.1 when I built this, but the current version might have a higher number (could be newer)."),
    answer("Other", message = "It was version 4.1.1 when I built this, but the current version might have a higher number (could be newer).")
  )
)
...
quiz(caption = "Quiz - Install RStudio",
  ...
  question("What is the current version of RStudio IDE?",
    answer("1.0.136", message = "It is at least version 1.4.1717."),
    answer("1.4.1717", correct = TRUE, "It was version 1.4.1717 when I built this, but the current version might have a higher number (could be newer)."),
    answer("4.1.1", message = "That was the current version of R, RStudio is at least version 1.4.1717."),
    answer("1.4", message = "It is at least version 1.4.1717."),
    answer("Other", message = "It was version 1.4.1717 when I built this, but the current version might have a higher number (could be newer).")
  )
)
```
