...
\href{https://style.tidyverse.org/}{(link)}. Installing the `styler` package will allow you to highlight code and format it in a more legible way. Visit \href{https://style.tidyverse.org/}{(the tidyverse page)} for more.
