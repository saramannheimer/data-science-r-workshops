...
header-includes: |
  \usepackage{fancyhdr}
  \pagestyle{fancy}
  \fancyfoot[LO,RE]{Intro to R Workshop - Presenter}
...
For this workshop, we will be making use of the RStudio that you will need to install on your computer. First you will want to go to https://cran.r-project.org/ to download for your speicfic operating system, run the `R` installer that you downloaded and then go to https://posit.co/download/rstudio-desktop/ to download and install RStudio.

For more assistance with getting set up, please check out the instructions provided 
in this tutorial https://rconnect.math.montana.edu/InstallDemo_RWorkshops/ and in the
instructions provided by Data Carpentries at https://datacarpentry.org/R-ecology-lesson/#install-r-and-rstudio.
...
mean(BlackfootFish$weight, na.rm = TRUE)  
...
## na.omit takes dataframes, matricies, and vectors and returns object 
...
The workshops for 2024-2025 involve modifications of materials and are being 
taught by:
