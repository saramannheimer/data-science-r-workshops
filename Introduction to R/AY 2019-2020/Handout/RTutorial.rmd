...
slight differences in syntax, it is good practice to always use `<-` for 
assignments.  
...
`y` is. Did it change from before?  
...
**Exercise 2:** Create a vector that contains decimal valued numbers. Then check
...
**Exercise 4:** What would be output if you entered: `x[3, ]`?  
...
**Exercise 7:** How would you pull off only columns `x` and `z`? Can you 
think of two ways to do it?
...
**Exercise 10:** What would you input to get an output of `[1] 22 49`? 
