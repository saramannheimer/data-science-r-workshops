...
surveys %>% 
  mutate(weekend = case_when(day_of_week == "Sat" ~ "Weekend",
...
# Could have collapsed Saturday and Sunday into a single comparison using OR
# This would look like: 
# case_when(day_of_week == "Sat" ~ "Weekend" | day_of_week == "Sun" ~ "Weekend")
# The | stands for "OR" in the logical statement!
