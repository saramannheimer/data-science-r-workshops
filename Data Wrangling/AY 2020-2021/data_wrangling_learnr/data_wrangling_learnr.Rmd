...
## Data Manipulation using **`dplyr`** & **`tidyr`** Intro
...
surveys <- read_csv("https://raw.githubusercontent.com/saramannheimer/data-science-r-workshops/master/Data%20Wrangling/AY%202020-2021/data/surveys2_subset.csv")
```
...
```{r caseWhen-example2, exercise=TRUE, exercise.setup="challenge-4-setup"}
