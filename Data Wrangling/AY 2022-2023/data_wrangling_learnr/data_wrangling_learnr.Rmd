...
*  These workshops are taught by Sara Mannheimer, Greta Linse, Harley Clifton, and Eliot Liucci and co-organized by the MSU Library, Statistical Consulting and Research Services (SCRS), and the Department of Mathematical Sciences. More details on us and other workshops are available at the end of the session.
...
```{r}
knitr::include_graphics("images/pivot_wider_graphic.png")
```
...
```{r}
knitr::include_graphics("images/pivot_longer_graphic.png")
```
