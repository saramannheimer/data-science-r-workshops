...
Install `Python` by going to https://www.python.org/downloads/ and download the
...
#Only need to run the following once:
Sys.setenv(RETICULATE_PYTHON = "C:/Users/greta/AppData/Local/Programs/Python/Python312/python.exe")
library(reticulate) # Integrates Python with R
reticulate::install_miniconda()
py_install(packages=c("pandas", "scipy", "numpy","matplotlib"))
```
