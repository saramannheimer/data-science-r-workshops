...
header-includes: |
  ...
  \fancyfoot[CO,CE]{September 29, 2021}
...
```{r challenge-1-solution, echo=FALSE, eval=FALSE}
ggplot(data = surveys, 
       mapping = aes(x = weight, y = hindfoot_length)) +
...
```{r challenge-2part1-solution, echo=FALSE, eval=FALSE}
surveys %>% 
  ggplot(mapping = aes(x = weight, y = hindfoot_length)) +
...
```{r challenge-2part2-solution, echo=FALSE, eval=FALSE}
surveys %>% 
...
```{r challenge-3part1-solution, echo=FALSE, eval=FALSE}
surveys %>% 
  ggplot(mapping = aes(x = species_id, y = weight)) +
    geom_violin() + 
...
```{r challenge-3part2-solution, echo=FALSE, eval=FALSE}
surveys %>% 
...
```{r challenge-3part3-solution, echo=FALSE, eval=FALSE}
surveys %>% 
  ggplot(mapping = aes(x = species_id, y = hindfoot_length)) +
...
```{r challenge-4-solution, echo=FALSE, eval=FALSE}
surveys %>% 
  ggplot(aes(x = weight)) + 
...
```{r challenge-6-solution, echo=FALSE, eval=FALSE}
surveys %>% 
...
```{r challenge-7-solution, echo=FALSE, eval=FALSE}
## To get you started:  
yearly_species_weight <- surveys %>% 
  ## Variables to group by:
  group_by(year, species_id) %>%
...
```{r challenge-8-solution, echo=FALSE, eval=FALSE}
yearly_species_weight %>% 
  ggplot(mapping = aes(x = year, y = avg_weight, color = species_id)) +
  geom_line() + 
  theme_classic()
...
```{r challenge-9-solution, echo=FALSE, eval=FALSE}
