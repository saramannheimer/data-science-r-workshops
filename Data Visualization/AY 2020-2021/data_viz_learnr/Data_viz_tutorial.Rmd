...
```{r preview-data, results = 'hide', exercise=TRUE}
## Preview the data
View(surveys)
```
...
```{r bind-plot, exercise=TRUE, exercise.eval=TRUE}
ggplot(data = surveys)
...
```{r define-mapping, exercise=TRUE, exercise.eval=TRUE}
ggplot(data = surveys, 
...
```{r add-to-plots, exercise=TRUE, exercise.eval=TRUE}
ggplot(data = surveys, 
       mapping = aes(x = weight, y = hindfoot_length)) +
  geom_point()
...
```{r plus-sign, results = 'hide', exercise=TRUE}
...
```{r build-plot, results = 'hide', exercise=TRUE}
ggplot(data = surveys, 
       mapping = aes(x = weight, y = hindfoot_length)) +
    geom_point()
```
...
```{r modify-plot, results = 'hide', exercise=TRUE}
ggplot(data = surveys, 
       mapping = aes(x = weight, y = hindfoot_length)) +
...
```{r color-plot, results = 'hide', exercise=TRUE}
ggplot(data = surveys, 
       mapping = aes(x = weight, y = hindfoot_length)) +
...
```{r pipe-example, results = 'hide', exercise=TRUE}
surveys %>%  
...
```{r color-example1, results = 'hide', exercise=TRUE}
surveys %>% 
  ggplot(mapping = aes(x = weight, y = hindfoot_length)) +
...
```{r color-example2, results = 'hide', exercise=TRUE}
surveys %>% 
...
```{r color-global, results = 'hide', exercise=TRUE}
surveys %>% 
  ggplot(mapping = aes(x = weight, y = hindfoot_length, color = species_id)) +
...
```{r boxplot1, results = 'hide', exercise=TRUE}
surveys %>% 
...
```{r boxplot2, results = 'hide', exercise=TRUE}
surveys %>% 
  ggplot(mapping = aes(x = species_id, y = weight)) +
...
>
> Replace the box plot with a violin plot. For help see `geom_violin()`. Start with the poxplot we >created:
>
>ggplot(data = surveys, mapping = aes(x = species_id, y = weight)) +
>  geom_boxplot(alpha = 0) +
>  geom_jitter(alpha = 0.3, color = "tomato")
>
>```{r challenge3part1, exercise=TRUE, exercise.lines = 7}
...
>```{r challenge3part2, exercise=TRUE, exercise.lines = 7}
...
>```{r challenge3part3, exercise=TRUE, exercise.lines = 7}
...
```{r dist-plot, results = 'hide', exercise=TRUE}
surveys %>% 
...
```{r dist-add-color, results = 'hide', exercise=TRUE}
surveys %>% 
  ggplot(mapping = aes(x = weight)) + 
...
```{r hist, results = 'hide', exercise=TRUE}
surveys %>% 
  ggplot(mapping = aes(x = weight)) + 
  geom_histogram()
...
```{r bar1, results = 'hide', exercise=TRUE}
surveys %>% 
...
```{r bar2, results = 'hide', exercise=TRUE}
surveys %>% 
  ggplot(mapping = aes(x = species_id)) + 
  stat_count()
```
...
```{r bar3, results = 'hide', exercise=TRUE}
surveys %>% 
  ggplot(mapping = aes(x = species_id)) + 
...
```{r bar4, results = 'hide', exercise=TRUE}
...
```{r bar5, results = 'hide', exercise=TRUE}
surveys %>% 
...
```{r stacking, results = 'hide', exercise=TRUE}
surveys %>% 
...
```{r timeseries1, results = 'hide', exercise=TRUE}
...
```{r timeseries2, results = 'hide', exercise=TRUE}
yearly_counts %>% 
...
```{r timeseries3, results = 'hide', exercise=TRUE}
yearly_counts %>% 
...
```{r timeseries4, results = 'hide', exercise=TRUE}
yearly_counts %>% 
...
```{r facet1, results = 'hide', exercise=TRUE}
yearly_counts %>% 
  ggplot(mapping = aes(x = year, y = n)) +
    geom_line() +
...
```{r facet2, results = 'hide', exercise=TRUE}
...
```{r facet3, results = 'hide', exercise=TRUE}
yearly_sex_counts %>% 
...
```{r facet4, fig.height = 8.5, fig.width = 8, results = 'hold', exercise = TRUE}
yearly_sex_counts %>% 
  ggplot(mapping = aes(x = year, y = n, color = sex)) +
  geom_line() +
...
```{r facet5, fig.width = 9.5, fig.height = 5, results = 'hold', exercise = TRUE}
yearly_sex_counts %>% 
  ggplot(mapping = aes(x = year, y = n, color = sex)) +
    geom_line() +
...
```{r facet6, fig.width = 9.5, results = 'hide', exercise=TRUE}
yearly_sex_counts %>% 
  ggplot(mapping = aes(x = year, y = n, color = sex)) +
    geom_line() +
...
>```{r challenge-7, exercise=TRUE, exercise.lines = 7}
>## To get you started:  
...
```{r themes1, results = 'hide', exercise=TRUE}
yearly_sex_counts %>% 
 ggplot(mapping = aes(x = year, y = n, color = sex)) +
     geom_line() +
...
```{r labels, results = 'hide', exercise=TRUE}
yearly_sex_counts %>% 
  ggplot(mapping = aes(x = year, y = n, color = sex)) +
  geom_line() +
  facet_wrap(vars(species_id)) +
...
```{r fonts, results = 'hide', exercise=TRUE}
yearly_sex_counts %>% 
  ggplot(mapping = aes(x = year, y = n, color = sex)) +
  geom_line() +
  facet_wrap(vars(species_id)) +
...
```{r flip, results = 'hide', exercise=TRUE}
yearly_sex_counts %>% 
  ggplot(mapping = aes(x = year, y = n, color = sex)) +
  geom_line() +
  facet_wrap(vars(species_id)) +
...
```{r text-size, results = 'hide', exercise=TRUE}
yearly_sex_counts %>% 
  ggplot(mapping = aes(x = year, y = n, color = sex)) +
  geom_line() +
  facet_wrap(vars(species_id)) +
...
```{r legend-pos, results = 'hide', exercise=TRUE}
yearly_sex_counts %>% 
  ggplot(mapping = aes(x = year, y = n, color = sex)) +
    geom_line() +
    facet_wrap(vars(species_id)) +
...
```{r remove-grid, results = 'hide', exercise=TRUE}
yearly_sex_counts %>% 
  ggplot(mapping = aes(x = year, y = n, color = sex)) +
  geom_line() +
  facet_wrap(vars(species_id)) +
...
```{r manual-colors, results = 'hide', exercise=TRUE}
...
```{r arrange, message = FALSE, fig.width = 10, results = 'hold', exercise = TRUE}
library(gridExtra)
...
```{r export, results = 'hide', exercise=TRUE, eval = FALSE}
